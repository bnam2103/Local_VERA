...
# ------------------------------
processor = SpeechT5Processor.from_pretrained(r"C:\Users\User\Documents\Fine_Tuning_Projects\TTS_Project\First_american_accent\speecht5_finetuned_voxpopuli_nl\checkpoint-8648")
model = SpeechT5ForTextToSpeech.from_pretrained(
    r"C:\Users\User\Documents\Fine_Tuning_Projects\TTS_Project\First_american_accent\speecht5_finetuned_voxpopuli_nl\checkpoint-8648", use_safetensors=True, trust_remote_code=True
)
vocoder = SpeechT5HifiGan.from_pretrained("./local_vocoder")
...
def speak(text: str, max_tokens=60):
